...
<!--  202005210938 サイト内を検索 エンジン表示をする　begin cuong-->
<?php
if ( !defined( 'ABSPATH' ) ) exit;
if (!is_amp() || !is_ssl()):
?>
<div class="ad-header-widget">
    <form class="search-box input-box" method="get" action="<?php echo home_url('/'); ?>">
        ...
        <form class="amp-form search-box" method="get" action="<?php echo home_url('/'); ?>" target="_top">
           ...
           　　 <!--  202005210938 グローバル検索 クリアのマーク表示をする　begin cuong-->
            <button style="margin-right:45px;width: 30px;height:50px;" type="reset" class="fa fa-times search-submit" aria-hidden="true"></button>
                <!--  202005210938 グローバル検索 クリアのマーク表示をする cuong -->
        </form>
     </form>
</div>
<!--  202005210938 サイト内を検索 エンジン表示をする cuong -->
...
print <<< eof
<!-- Google  -->
<!--  202005210938 グローバル検索 エンジン表示をする　begin cuong-->
<html>
<body>
<div class="search-box input-box">
...
<button type="submit" class="search-submit" role="button" aria-label="button"></button>
<!--  202005210938 グローバル検索 クリアのマーク表示をする　begin cuong-->
<button style="margin-right:45px;width: 30px;padding-top:16px;height:50px;" type="reset" class="fa fa-times search-submit" aria-hidden="true">
<!--  202005210938　グローバル検索 クリアのマーク表示をする cuong -->
</p>
</form>
</div>
...
<!--  202005210938　グローバル検索 エンジン表示をする cuong -->
...
<!-- Google - yahoo -bing  検索ボタンを一時的に消す -->

<!--  202005210938 検索エンジン表示を消すbegin cuong
...
202005210938 検索エンジン表示を消す cuong -->
